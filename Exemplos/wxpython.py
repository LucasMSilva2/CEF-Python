# Exemplo de incorporação do navegador CEF Python usando a biblioteca wxPython.
# Este exemplo tem um menu superior e um widget de navegador sem barra de navegação
